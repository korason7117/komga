# [1.11.0](https://github.com/korason7117/komga/compare/1.10.0...1.11.0) (2026-09-17)
## 🚀 Features
**api**
- support image caching for transient book pages ([5e4637d](https://github.com/korason7117/komga/commits/5e4637d))
- return a ProblemDetail on MaxUploadSizeExceededException ([352cf75](https://github.com/korason7117/komga/commits/352cf75))
- allow listing public settings ([6f39abc](https://github.com/korason7117/komga/commits/6f39abc))
- allow sorting for getCollections API ([a5b252d](https://github.com/korason7117/komga/commits/a5b252d))

**komga-tray**
- add tray menu to open nextui ([50094a1](https://github.com/korason7117/komga/commits/50094a1))

**nextui**
- display book details in import book table ([882557c](https://github.com/korason7117/komga/commits/882557c))
- add series and book links in history table ([e98fd4c](https://github.com/korason7117/komga/commits/e98fd4c))
- use a button to select series in import books table ([9772f94](https://github.com/korason7117/komga/commits/9772f94))
- compare books in book import table ([249105e](https://github.com/korason7117/komga/commits/249105e))
- edit series fields when editing oneshot book ([22ab95c](https://github.com/korason7117/komga/commits/22ab95c))
- edit single series dialog ([6f911d7](https://github.com/korason7117/komga/commits/6f911d7))
- show series attributes on book view for oneshots ([f643ba3](https://github.com/korason7117/komga/commits/f643ba3))
- edit single book dialog ([58322a3](https://github.com/korason7117/komga/commits/58322a3))
- add external link indicator on announcement cards, and wrap title ([6001521](https://github.com/korason7117/komga/commits/6001521))
- add external link indicator on release cards ([457de01](https://github.com/korason7117/komga/commits/457de01))
- add chevron icon on touch devices when overview sections are links ([169e1a4](https://github.com/korason7117/komga/commits/169e1a4))
- remove underline links on touch devices ([b719887](https://github.com/korason7117/komga/commits/b719887))
- support for RTL locales ([376f104](https://github.com/korason7117/komga/commits/376f104))
- display error count on tabs in read list edit dialog ([c210b9b](https://github.com/korason7117/komga/commits/c210b9b))
- display error count on tabs in collection edit dialog ([6bf5375](https://github.com/korason7117/komga/commits/6bf5375))
- rearrange library creation/edition dialog ([c4eafa2](https://github.com/korason7117/komga/commits/c4eafa2))
- add v-ktooltip directive ([702601c](https://github.com/korason7117/komga/commits/702601c))
- add KTooltip component ([0881dde](https://github.com/korason7117/komga/commits/0881dde))
- support pasting cover images from clipboard ([579edce](https://github.com/korason7117/komga/commits/579edce)), closes [#1597](https://github.com/korason7117/komga/issues/1597)
- edit read list action ([afc57a7](https://github.com/korason7117/komga/commits/afc57a7))
- edit collection action ([f3cb447](https://github.com/korason7117/komga/commits/f3cb447))
- support unpacking API error message from ProblemDetail ([3e8e171](https://github.com/korason7117/komga/commits/3e8e171))
- add to collection action ([d55a443](https://github.com/korason7117/komga/commits/d55a443))
- add to read list action ([f22f57d](https://github.com/korason7117/komga/commits/f22f57d))

## 🐛 Fixes
**api**
- missing restrictions on some readlist endpoints ([478dc8b](https://github.com/korason7117/komga/commits/478dc8b))

**nextui**
- use querycache.refresh instead of fetch ([e008682](https://github.com/korason7117/komga/commits/e008682))
- correct toolbar alignment ([785e99c](https://github.com/korason7117/komga/commits/785e99c))
- disallow book upgrade selection for oneshot series ([2e444a8](https://github.com/korason7117/komga/commits/2e444a8))
- rework edit dialog spacing ([48a92a6](https://github.com/korason7117/komga/commits/48a92a6))
- better handling of dialog callback ([401676f](https://github.com/korason7117/komga/commits/401676f))
- use square tabs ([4cb2b47](https://github.com/korason7117/komga/commits/4cb2b47))
- missed updates from SSE ([f41c069](https://github.com/korason7117/komga/commits/f41c069))
- do not prepend on deck book number with # on series view ([f2d1770](https://github.com/korason7117/komga/commits/f2d1770)), closes [#2418](https://github.com/korason7117/komga/issues/2418)
- better tooltips on mobile ([298a1e2](https://github.com/korason7117/komga/commits/298a1e2))
- properly refresh posters upon receiving sse ([d675304](https://github.com/korason7117/komga/commits/d675304))
- use normal density for the read list import file upload component ([06501da](https://github.com/korason7117/komga/commits/06501da))
- user hasRole default to false instead of undefined ([0345f13](https://github.com/korason7117/komga/commits/0345f13))
- don't try to retrieve announcements if the user is not admin ([1d4e933](https://github.com/korason7117/komga/commits/1d4e933))
- use menu icon for navigation drawer on mobile ([174ce65](https://github.com/korason7117/komga/commits/174ce65))
- card text would be cut off short ([0c044e2](https://github.com/korason7117/komga/commits/0c044e2))

## 🏎 Perf
**nextui**
- only load current locale ([c5ff5db](https://github.com/korason7117/komga/commits/c5ff5db))

## 🔄️ Changes
**nextui**
- use querycache instead of reactive queries in global error handler ([fe215e4](https://github.com/korason7117/komga/commits/fe215e4))
- remove unnecessary refetch ([e8cc58a](https://github.com/korason7117/komga/commits/e8cc58a))
- use createGlobalState for singleton composables ([d4d8494](https://github.com/korason7117/komga/commits/d4d8494))
- normalize stale time ([cc8b857](https://github.com/korason7117/komga/commits/cc8b857))
- remove console output ([5081b67](https://github.com/korason7117/komga/commits/5081b67))
- extract logic in app releases query into composable ([ae3fcf8](https://github.com/korason7117/komga/commits/ae3fcf8))
- untangle logic in libraries and client settings queries ([89cd951](https://github.com/korason7117/komga/commits/89cd951))
- use querycache instead of reactive queries in navigation guard ([1411b65](https://github.com/korason7117/komga/commits/1411b65))
- move pinia colada query to the main context for useBooks ([e204543](https://github.com/korason7117/komga/commits/e204543))
- move pinia colada query to the main context for ImportReadlistTable ([29184d1](https://github.com/korason7117/komga/commits/29184d1))
- move pinia colada query to the main context ([661a5bf](https://github.com/korason7117/komga/commits/661a5bf))
- use renderless component in TransientBooksTable ([c9648e9](https://github.com/korason7117/komga/commits/c9648e9))
- move util functions to functions directory ([ae1fadb](https://github.com/korason7117/komga/commits/ae1fadb))
- extract error count into composable ([bf521d5](https://github.com/korason7117/komga/commits/bf521d5))
- small fixes following openapi updates ([b8c2f9b](https://github.com/korason7117/komga/commits/b8c2f9b))
- replace cardTextClass with cardTextProps for dialogs ([42f2aad](https://github.com/korason7117/komga/commits/42f2aad))

## 🧪 Tests
**nextui**
- update optimizeDeps ([7322c4e](https://github.com/korason7117/komga/commits/7322c4e))
- fix msw mocks ([2cf933a](https://github.com/korason7117/komga/commits/2cf933a))

## 🛠  Build
**chromatic**
- ignore dependabot ([234b302](https://github.com/korason7117/komga/commits/234b302))

**deps**
- bump qs from 6.15.3 to 6.16.0 in /next-ui ([a2cf953](https://github.com/korason7117/komga/commits/a2cf953))

**deps-dev**
- bump vitest from 4.1.10 to 4.1.11 in /next-ui ([fa4d1f3](https://github.com/korason7117/komga/commits/fa4d1f3))
- bump @humanfs/node from 0.16.6 to 0.16.8 in /next-ui ([f9c4688](https://github.com/korason7117/komga/commits/f9c4688))

**nextui**
- cleanup empty translation files in src/i18n instead of i18n ([328112d](https://github.com/korason7117/komga/commits/328112d))
- rework i18n handling to remove empty files ([2dbbaf0](https://github.com/korason7117/komga/commits/2dbbaf0))
- validate translations ([97c0845](https://github.com/korason7117/komga/commits/97c0845))
- add unhead ([094daea](https://github.com/korason7117/komga/commits/094daea))
- generate valibot schemas from openapi ([0909538](https://github.com/korason7117/komga/commits/0909538))
- upgrade Vuetify to 4.2.0 ([bb29ff4](https://github.com/korason7117/komga/commits/bb29ff4))
- configure throwOnError for the openapi generator ([48e56a6](https://github.com/korason7117/komga/commits/48e56a6))

**webui**
- update Browserslist db ([98ee3a8](https://github.com/korason7117/komga/commits/98ee3a8))

## 📝 Documentation
**nextui**
- bump deps ([e209a39](https://github.com/korason7117/komga/commits/e209a39))

**openapi**
- expose sort parameter for getReadLists API ([fac2f15](https://github.com/korason7117/komga/commits/fac2f15))

**unscoped**
- drop build badge in README ([f8e8990](https://github.com/korason7117/komga/commits/f8e8990))
- add LLM/AI contribution guidelines ([6b4397f](https://github.com/korason7117/komga/commits/6b4397f))
- create SECURITY.md ([c0135eb](https://github.com/korason7117/komga/commits/c0135eb))

## 🌐 Translation
**komga-tray**
- translated using Weblate (Italian) ([db36d3b](https://github.com/korason7117/komga/commits/db36d3b))
- translated using Weblate (Malayalam) ([2d6f43f](https://github.com/korason7117/komga/commits/2d6f43f))
- translated using Weblate (Vietnamese) ([ca18d8a](https://github.com/korason7117/komga/commits/ca18d8a))

**nextui**
- translated using Weblate (Chinese (Simplified Han script)) ([01bd27d](https://github.com/korason7117/komga/commits/01bd27d))
- translated using Weblate ([17d6fac](https://github.com/korason7117/komga/commits/17d6fac))
- translated using Weblate (Korean) ([5c2b620](https://github.com/korason7117/komga/commits/5c2b620))
- translated using Weblate (French) ([0167fd8](https://github.com/korason7117/komga/commits/0167fd8))
- translated using Weblate ([f65a56e](https://github.com/korason7117/komga/commits/f65a56e))
- translated using Weblate ([47941a8](https://github.com/korason7117/komga/commits/47941a8))
- translated using Weblate ([9008a85](https://github.com/korason7117/komga/commits/9008a85))
- translated using Weblate ([142c347](https://github.com/korason7117/komga/commits/142c347))
- translated using Weblate ([81ee1f1](https://github.com/korason7117/komga/commits/81ee1f1))
- translated using Weblate ([7422878](https://github.com/korason7117/komga/commits/7422878))
- translated using Weblate ([3ce5873](https://github.com/korason7117/komga/commits/3ce5873))
- translated using Weblate ([cbc4871](https://github.com/korason7117/komga/commits/cbc4871))
- translated using Weblate ([bf4e1e0](https://github.com/korason7117/komga/commits/bf4e1e0))
- translated using Weblate ([e99fb8a](https://github.com/korason7117/komga/commits/e99fb8a))
- translated using Weblate ([76aec63](https://github.com/korason7117/komga/commits/76aec63))
- translated using Weblate ([d017908](https://github.com/korason7117/komga/commits/d017908))
- translated using Weblate ([69da2c4](https://github.com/korason7117/komga/commits/69da2c4))
- translated using Weblate ([c2ccfb2](https://github.com/korason7117/komga/commits/c2ccfb2))
- translated using Weblate ([fd870c9](https://github.com/korason7117/komga/commits/fd870c9))
- extract translation strings ([d6bae91](https://github.com/korason7117/komga/commits/d6bae91))
- add missing i18n string ([e931487](https://github.com/korason7117/komga/commits/e931487))

**webui**
- translated using Weblate (Chinese (Simplified Han script)) ([f0f95ef](https://github.com/korason7117/komga/commits/f0f95ef))
- translated using Weblate (Slovak) ([4a803bc](https://github.com/korason7117/komga/commits/4a803bc))
- translated using Weblate (Korean) ([f9d4585](https://github.com/korason7117/komga/commits/f9d4585))
- translated using Weblate (Spanish) ([8172ec9](https://github.com/korason7117/komga/commits/8172ec9))
- translated using Weblate (Italian) ([19534cc](https://github.com/korason7117/komga/commits/19534cc))
- added translation using Weblate (Malayalam) ([10e2dff](https://github.com/korason7117/komga/commits/10e2dff))
- translated using Weblate (Czech) ([d384ba3](https://github.com/korason7117/komga/commits/d384ba3))
- translated using Weblate (Ukrainian) ([62594f8](https://github.com/korason7117/komga/commits/62594f8))
- translated using Weblate (German) ([b04138e](https://github.com/korason7117/komga/commits/b04138e))
- translated using Weblate (Turkish) ([5aba11e](https://github.com/korason7117/komga/commits/5aba11e))

## ⚙️ Dependencies
**ci**
- bump hydraulic-software/conveyor from 22.1 to 22.2 ([d512b67](https://github.com/korason7117/komga/commits/d512b67))
- bump actions/setup-java from 5 to 6 ([717edb9](https://github.com/korason7117/komga/commits/717edb9))
- bump EndBug/add-and-commit from 10 to 11 ([cba53ed](https://github.com/korason7117/komga/commits/cba53ed))

**nextui**
- bump storybook to 10.5.9 ([f3bfeb1](https://github.com/korason7117/komga/commits/f3bfeb1))

**webui**
- bump svgo from 2.8.3 to 2.8.4 in /komga-webui ([9707eda](https://github.com/korason7117/komga/commits/9707eda))
- bump js-yaml from 3.14.2 to 3.15.2 in /komga-webui ([d4e33f1](https://github.com/korason7117/komga/commits/d4e33f1))
- bump joi from 17.10.1 to 17.13.7 in /komga-webui ([355177c](https://github.com/korason7117/komga/commits/355177c))
- bump browserslist from 4.28.1 to 4.28.8 in /komga-webui ([656001e](https://github.com/korason7117/komga/commits/656001e))
- bump @xmldom/xmldom from 0.8.13 to 0.8.15 in /komga-webui ([fcf8c59](https://github.com/korason7117/komga/commits/fcf8c59))
- bump qs from 6.15.2 to 6.16.0 in /komga-webui ([4217b75](https://github.com/korason7117/komga/commits/4217b75))
- bump fast-uri from 3.1.5 to 3.1.7 in /komga-webui ([1fdc140](https://github.com/korason7117/komga/commits/1fdc140))
- bump sanitize-html from 2.12.1 to 2.17.7 in /komga-webui ([50ee199](https://github.com/korason7117/komga/commits/50ee199))
